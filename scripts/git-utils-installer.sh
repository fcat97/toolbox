...
# copy parmalink => open in incognito => click on raw button => copy url
SCRIPT_URL="https://raw.githubusercontent.com/fcat97/toolbox/724f9ce36ef2ca032f497176351aae9e8944807a/scripts/git-utils.sh"
